...
-- \copy restaurant(rest_name) FROM './dummydata/restaurant.csv' CSV
\copy menu_dietary(menu_id, dietary_id) FROM './dummydata/menuDiatery.csv' DELIMITER ',' CSV
--\copy menu(section_name, time_id) From './dummydata/menuSection.csv' DELIMITER ',' CSV
